...
public interface MemberAttributesModuleImplApi extends AttributesModuleImplApi {
    ...
    /**
     * Checks if assigned attribute to the member has valid syntax.
     *
     * @param session   Perun session
     * @param member    Member
     * @param attribute Attribute of the member.
     ...
     * @throws WrongAttributeAssignmentException
     */
    void checkAttributeSyntax(PerunSessionImpl session, Member member, Attribute attribute) throws InternalErrorException, WrongAttributeValueException, WrongAttributeAssignmentException, WrongReferenceAttributeValueException;
