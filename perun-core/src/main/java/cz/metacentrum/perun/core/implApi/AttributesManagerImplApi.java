...
public interface AttributesManagerImplApi {
	 ...
	 * @throws WrongReferenceAttributeValueException
	 */
	void checkAttributeSyntax(PerunSession sess, Member member, Resource resource, Attribute attribute) throws InternalErrorException, WrongAttributeValueException, WrongReferenceAttributeValueException;
