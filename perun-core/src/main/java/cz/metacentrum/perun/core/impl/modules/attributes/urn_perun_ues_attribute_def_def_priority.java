...
public class urn_perun_ues_attribute_def_def_priority extends UserExtSourceAttributesModuleAbstract implements UserExtSourceAttributesModuleImplApi {
	...
	public void checkAttributeSemantics(PerunSessionImpl sess, UserExtSource userExtSource, Attribute attribute) throws InternalErrorException, WrongAttributeValueException, WrongAttributeAssignmentException {
