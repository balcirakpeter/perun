...
public interface ResourceMemberAttributesModuleImplApi extends AttributesModuleImplApi {
     ...
     * @throws WrongAttributeAssignmentException
     */
    void checkAttributeSyntax(PerunSessionImpl perunSession, Resource resource, Member member, Attribute attribute) throws InternalErrorException, WrongAttributeValueException, WrongReferenceAttributeValueException, WrongAttributeAssignmentException;
